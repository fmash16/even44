...
FINGER_GRID = 
    [[0, 2], [1, 2], [2, 2.50], [3, 2.70], [4, 2.50], [5, 2.37],
     [0, 1], [1, 1], [2, 1.50], [3, 1.70], [4, 1.50], [5, 1.37],
     [0, 0], [1, 0], [2, 0.50], [3, 0.70], [4, 0.50], [5, 0.37]];

FINGER_BOLT_HOLES =
    [[1, 2], [5, 2.185],
     [1, 1], [5, 1.185]];

//THUMB_GRID = [[-1,0], [0, 0], [1, 0.1]];
THUMB_GRID = [[1.15, 0.3]];
THUMB_GRID_2 = [[-1.95,0.28], [-0.95,0.37], [0.15, 0.45]];
